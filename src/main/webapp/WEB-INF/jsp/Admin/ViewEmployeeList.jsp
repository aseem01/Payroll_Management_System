                ...
                <div class="col-md-10" style="    margin-left: -12px;">
                    <div class="w3-card-4">
                           ...
                           <div class="col-md-1">
                            ...
                            <div class="col-md-10">
                                <center><h2>Employee Salary</h2></center>
                                ...
                                <table id="mydata" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 17%;text-align: ceneter">Basic Salary</th>
                                            <th style="width: 16%;text-align: center">Designation</th>
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                <td algin="center">${emp.name}</td>
                                                <td algin="center">${emp.accNo}</td>
                                                <td align="center">${emp.basicSalary}</td>
                                                <td align="center">${emp.designation}</td>
                                                <td align="center">${emp.total}</td>
