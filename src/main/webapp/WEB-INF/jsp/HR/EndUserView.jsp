                                ...
                                <tbody>
                                    <c:forEach items="${emp}" var="user">
                                        <tr>
                                            ...
                                            <td><a href="UpdateEmployeeInformation?empId=${user.empId}"><button onclick="return confirmation();" style="background-color: #22701f;width: 70px"><font color="white">Update</button></a>
