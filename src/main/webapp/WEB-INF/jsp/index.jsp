<%-- 
    Document   : index
    Created on : April 14, 2019, 2:03:57 AM
    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10" style="background-color: #93958B">
                    <center> <h1 style="color: #1D3575"><strong>PayRoll Management System</strong></h1></center>
                </div>
            </div>
                            ...
                            <form id="login-form" method="POST" action="UserLogin" class="form-inline" autocomplete="off" style="margin-left: 18%">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <input id="userNameValidation" type="text" name="username" class="form-control" placeholder="Enter Email"  autofocus required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> <br></td>
